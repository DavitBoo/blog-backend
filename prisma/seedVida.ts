...
const ITEMS: SeedItem[] = [
  {
    slug: 'ejemplo-proyecto-1',
    categoria: 'proyectos',
    ambito: 'desarrollo',
    titulo: 'Ítem de ejemplo — Proyectos 1',
    resumen:
      'Contenido de ejemplo para comprobar que la isla se ve bien. Sustitúyelo desde el panel de administración.',
    ...
    peso: 5,
    tags: ['ejemplo'],
    enlaces: [{ tipo: 'web', url: 'https://example.com', etiqueta: 'Enlace de ejemplo' }],
    relacionados: ['ejemplo-viaje-1'],
  },
  {
    slug: 'ejemplo-proyecto-2',
    categoria: 'proyectos',
    ambito: 'lutheria',
    titulo: 'Ítem de ejemplo — Proyectos 2',
    resumen:
      'Contenido de ejemplo para comprobar que la isla se ve bien. Sustitúyelo desde el panel de administración.',
  ...
  {
    slug: 'ejemplo-viaje-1',
    categoria: 'viajes',
    titulo: 'Ítem de ejemplo — Viajes 1',
    resumen:
      'Contenido de ejemplo para comprobar que la isla se ve bien. Sustitúyelo desde el panel de administración.',
  ...
  {
    slug: 'ejemplo-viaje-2',
    categoria: 'viajes',
    titulo: 'Ítem de ejemplo — Viajes 2',
    resumen:
      'Contenido de ejemplo para comprobar que la isla se ve bien. Sustitúyelo desde el panel de administración.',
    fechaInicio: '2020',
    precisionFecha: 'anio',
  ...
  {
    slug: 'ejemplo-trabajo-1',
    categoria: 'trabajos',
    titulo: 'Ítem de ejemplo — Trabajos 1',
    resumen:
      'Contenido de ejemplo para comprobar que la isla se ve bien. Sustitúyelo desde el panel de administración.',
  ...
  {
    slug: 'ejemplo-trabajo-2',
    categoria: 'trabajos',
    titulo: 'Ítem de ejemplo — Trabajos 2',
    resumen:
      'Contenido de ejemplo para comprobar que la isla se ve bien. Sustitúyelo desde el panel de administración.',
    fechaInicio: '2022',
    precisionFecha: 'anio',
  ...
  {
    slug: 'ejemplo-estudio-1',
    categoria: 'estudios',
    titulo: 'Ítem de ejemplo — Estudios 1',
    resumen:
      'Contenido de ejemplo para comprobar que la isla se ve bien. Sustitúyelo desde el panel de administración.',
    fechaInicio: '2018',
    precisionFecha: 'anio',
  ...
  {
    slug: 'ejemplo-estudio-2',
    categoria: 'estudios',
    titulo: 'Ítem de ejemplo — Estudios 2',
    resumen:
      'Contenido de ejemplo para comprobar que la isla se ve bien. Sustitúyelo desde el panel de administración.',
    fechaInicio: '2024',
    precisionFecha: 'anio',
  ...
  {
    slug: 'ejemplo-idioma-1',
    categoria: 'idiomas',
    titulo: 'Ítem de ejemplo — Idiomas 1',
    resumen:
      'Contenido de ejemplo para comprobar que la isla se ve bien. Sustitúyelo desde el panel de administración.',
    fechaInicio: '2010',
    precisionFecha: 'anio',
  ...
  {
    slug: 'ejemplo-idioma-2',
    categoria: 'idiomas',
    titulo: 'Ítem de ejemplo — Idiomas 2',
    resumen:
      'Contenido de ejemplo para comprobar que la isla se ve bien. Sustitúyelo desde el panel de administración.',
    fechaInicio: '2019',
    precisionFecha: 'anio',
  ...
  {
    slug: 'ejemplo-musica-1',
    categoria: 'musica',
    titulo: 'Ítem de ejemplo — Música 1',
    resumen:
      'Contenido de ejemplo para comprobar que la isla se ve bien. Sustitúyelo desde el panel de administración.',
  ...
  {
    slug: 'ejemplo-musica-2',
    categoria: 'musica',
    titulo: 'Ítem de ejemplo — Música 2',
    resumen:
      'Contenido de ejemplo para comprobar que la isla se ve bien. Sustitúyelo desde el panel de administración.',
    fechaInicio: '2023',
    precisionFecha: 'anio',
...
const LIBROS = [
  {
    ...
    anioLectura: new Date().getFullYear(),
    genero: 'Novela',
    nota: 'Nota de ejemplo — sustitúyela desde el panel de administración.',
    color: '#2f6b7a',
    destacado: true,
    paginas: 320,
  },
  {
    ...
    autor: 'Autor de ejemplo',
    anioLectura: new Date().getFullYear() - 1,
    genero: 'Ensayo',
    color: '#8a6a3d',
    destacado: true,
    paginas: 210,
  },
  {
    ...
    anioLectura: new Date().getFullYear() - 1,
    genero: 'Técnico',
    nota: 'Otra nota de ejemplo, más corta.',
    color: '#6b4a3a',
    destacado: false,
    paginas: 180,
  },
  {
    titulo: 'Libro de ejemplo 4',
    autor: 'Autor de ejemplo',
    anioLectura: new Date().getFullYear() - 2,
    genero: 'Novela',
    color: '#3d5a8a',
    destacado: false,
    paginas: 260,
